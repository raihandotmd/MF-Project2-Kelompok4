            ...
            <div class="w3_agile_featured_movies two">
                ...
                <div class="col-md-7 wthree_agile-movies_list second-top">
                    <div class="w3l-movie-gride-agile">
                        <a href="single.html" class="hvr-sweep-to-bottom"><img src="assets/images/m1.jpg" title="Movies Pro" class="img-responsive" alt=" ">
                            ...
                            <div class="mid-2 agile_mid_2_home">
                                ...
                                <div class="block-stars">
                                    <ul class="w3l-ratings">
                                        ...
                                        <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star-half" viewBox="0 0 16 16">
                                                    <path d="M5.354 5.119 7.538.792A.516.516 0 0 1 8 .5c.183 0 .366.097.465.292l2.184 4.327 4.898.696A.537.537 0 0 1 16 6.32a.548.548 0 0 1-.17.445l-3.523 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256a.52.52 0 0 1-.146.05c-.342.06-.668-.254-.6-.642l.83-4.73L.173 6.765a.55.55 0 0 1-.172-.403.58.58 0 0 1 .085-.302.513.513 0 0 1 .37-.245l4.898-.696zM8 12.027a.5.5 0 0 1 .232.056l3.686 1.894-.694-3.957a.565.565 0 0 1 .162-.505l2.907-2.77-4.052-.576a.525.525 0 0 1-.393-.288L8.001 2.223 8 2.226v9.8z" />
                                                </svg></a>
                                        </li>
                                    </ul>
                    ...
                    <div class="w3l-movie-gride-agile">
                        <a href="single.html" class="hvr-sweep-to-bottom"><img src="assets/images/m2.jpg" title="Movies Pro" class="img-responsive" alt=" ">
                            <div class="w3l-action-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                    <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                                </svg>
                            ...
                            <div class="mid-2 agile_mid_2_home">
                                ...
                                <div class="block-stars">
                                    <ul class="w3l-ratings">
                                        ...
                                        <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">
                                                    <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.565.565 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z" />
                                                </svg></a>
                                        </li>
                                    </ul>
                    ...
                    <div class="w3l-movie-gride-agile">
                        <a href="single.html" class="hvr-sweep-to-bottom"><img src="assets/images/m3.jpg" title="Movies Pro" class="img-responsive" alt=" ">
                            <div class="w3l-action-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                    <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                                </svg>
                    ...
                    <div class="w3l-movie-gride-agile">
                        <a href="single.html" class="hvr-sweep-to-bottom"><img src="assets/images/m4.jpg" title="Movies Pro" class="img-responsive" alt=" ">
                            <div class="w3l-action-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                    <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                                </svg>
                    ...
                    <div class="w3l-movie-gride-agile">
                        <a href="single.html" class="hvr-sweep-to-bottom"><img src="assets/images/m5.jpg" title="Movies Pro" class="img-responsive" alt=" ">
                            <div class="w3l-action-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                    <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                                </svg>
                    ...
                    <div class="w3l-movie-gride-agile">
                        <a href="single.html" class="hvr-sweep-to-bottom"><img src="assets/images/m6.jpg" title="Movies Pro" class="img-responsive" alt=" ">
                            <div class="w3l-action-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                    <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                                </svg>
                    ...
                    <div class="w3l-movie-gride-agile">
                        <a href="single.html" class="hvr-sweep-to-bottom"><img src="assets/images/m7.jpg" title="Movies Pro" class="img-responsive" alt=" ">
                            <div class="w3l-action-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                    <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                                </svg>
                    ...
                    <div class="w3l-movie-gride-agile">
                        <a href="single.html" class="hvr-sweep-to-bottom"><img src="assets/images/m8.jpg" title="Movies Pro" class="img-responsive" alt=" ">
                            <div class="w3l-action-icon">
                            ...
                            <div class="w3_agile_featured_movies">
                                <div class="col-md-5 video_agile_player">
                                    <div class="video-grid-single-page-agileits">
                                        <div data-video="f2Z65fobH2I" id="video"> <video width="800" height="550" controls>
                                    ...
                                    <div class="player-text two">
                                        ...
                                        <p class="fexi_header_para"><span>Release On<label>:</label></span>Aug 1, 2023
                                        </p>
                            ...
                            <div class="thumb">
                                <div class="hover-content">
                                    <ul>
                                        ...
                                        <li><a href="https://www.youtube.com/watch?v=avz06PDqDbM"><svg xmlns="http://www.w3.org/2000/svg" width="90px" height="90px" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                                    <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                                                </svg></a></li>
                            ...
                            <div class="thumb">
                                <div class="hover-content">
                                    <ul>
                                        ...
                                        <li><a href="https://www.youtube.com/watch?v=jzQn0-WH4WM"><i class="fa fa-star"></i></a></li>
                            ...
                            <div class="thumb">
                                <div class="hover-content">
                                    <ul>
                                        ...
                                        <li><a href="https://www.youtube.com/watch?v=DhlaBO-SwVE"><i class="fa fa-star"></i></a></li>
                            ...
                            <div class="thumb">
                                <div class="hover-content">
                                    <ul>
                                        ...
                                        <li><a href="https://www.youtube.com/watch?v=zL2BtTdIuLI"><i class="fa fa-star"></i></a></li>
...
<section class="feature_section layout_padding">
    <div class="container">
        <div class="heading_container">
            ...
            <p>
                Modern cinemas usually offer various facilities to enhance the movie viewing experience for viewers. Here are some of the facilities commonly found in cinemas
            </p>
        </div>
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <div class="box">
                    ...
                    <div class="detail-box">
                        ...
                        <p>
                            Cinemas are equipped with large screens that present high-resolution movie images. These screens are designed to provide an immersive, cinematic experience.
                        </p>
                        <br><br><br>
                        <a href="">
                            <div class="promo-box">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="box">
                    ...
                    <div class="detail-box">
                        ...
                        <p>
                            Cinemas are equipped with high-quality audio systems, such as Dolby Atmos or other surround sound systems. This allows viewers to enjoy clear and immersive sound effects during movie viewing.
                        </p>
                        <br>
                        <a href="">
                            <a href="">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="box">
                    ...
                    <div class="detail-box">
                        ...
                        <p>
                            Modern cinemas are usually equipped with comfortable seats. Some theaters even offer reclining seats or VIP seats for more space and extra comfort.
                        </p>
                        <br><br>
                        <a href="">
                            <a href="">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="box">
                    ...
                    <div class="detail-box">
                        ...
                        <p>
                            Cinemas often have a food and drink area located within their complex. Viewers can purchase snacks, drinks or a full meal before or after the movie.
                        </p>
                        <br>
                        <a href="">
                            <a href="">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="box">
                    ...
                    <div class="detail-box">
                        ...
                        <p>
                            Cinemas provide toilet facilities and other public facilities such as smoking areas, nursing rooms, and accessibility for persons with disabilities.
                        </p>
                        <br><br>
                        <a href="">
                            <div class="promo-box">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="box">
                    ...
                    <div class="detail-box">
                        ...
                        <p>
                            In cinemas, there is usually a special counter that sells snacks such as popcorn, candy, chips and soft drinks. This snack is a popular choice to enjoy during a movie.
                        </p>
                        <br><br>
                        <a href="">
                            <a href="">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="box">
                    ...
                    <div class="detail-box">
                        ...
                        <p>
                            Cinemas often have sufficient parking facilities for spectator vehicles. This makes it easier for the audience to find a safe parking space close to the cinema.
                        </p>
                        <br>
                        <a href="">
                            <a href="">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="box">
                    ...
                    <div class="detail-box">
                        ...
                        <p>
                            There is usually a comfortable waiting area in theaters, where audience members can sit back and relax before the movie starts. Some cinemas also offer a waiting room equipped with a play area or billiard room.
                        </p>
                        <a href="">
                            <a href="">
                                <div class="promo-box">
        ...
        <div class="row">
                ...
                <div class="form_container">
                    ...
                    <form action="">
                        ...
                        <div class="flex flex-col relative">
                            ...
                            <br>
                            <span class="text-secondary-gray text-sm mb-3">Upload any relevant files regarding your event. *Max size
                                5 mb</span>
                            <br>
                            <label class="w-1/2 lg:w-1/5 flex flex-col items-center p-2 bg-white text-blue rounded-full tracking-wide border border-primary-gray cursor-pointer hover:opacity-75" id="fileUpload">
                                <span class="text-sm font-semibold text-primary-gray">Browse File</span>
                                <input type="file" name="file" class="hidden" id="attachment" accept=".pdf,.docx,.doc,.xlsx,.xls,.pptx,.ppt,.rar,.zip,.jpg,.jpeg,.png,.mp4,.mov">
                            </label>
                        ...
                        <div class="flex flex-col">
                            <div id="inline-badge" class="h-[60px]">
                                <div class="grecaptcha-badge" data-style="inline" style="width: 256px; height: 60px; box-shadow: gray 0px 0px 5px;">
                                    <div class="grecaptcha-logo"><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LcBeF0mAAAAANPfoX-nxmBeO8yW56rMA1o56kzD&amp;co=aHR0cHM6Ly93d3cudGl4LmlkOjQ0Mw..&amp;hl=id&amp;v=khH7Ei3klcvfRI74FvDcfuOo&amp;size=invisible&amp;badge=inline&amp;cb=8joscchpc2t6" width="256" height="60" role="presentation" name="a-kduxxwv3suvr" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox allow-storage-access-by-user-activation"></iframe></div>
            ...
            <div class="col-md-6">
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                    <iframe class="position-relative rounded w-400 h-100" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3001156.4288297426!2d-78.01371936852176!3d42.72876761954724!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4ccc4bf0f123a5a9%3A0xddcfc6c1de189567!2sNew%20York%2C%20USA!5e0!3m2!1sen!2sbd!4v1603794290143!5m2!1sen!2sbd" frameborder="0" style="min-height: 850px; width:950px; border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                            <a class="btn btn-square mx-1" href="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="500" height="500" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
                                </svg>
                            </a>
                            <a class="btn btn-square mx-1" href="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="500" height="500" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
                                    <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016a5.54 5.54 0 0 1 .016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225h2.4z" />
                                </svg>
                            </a>
                            <a class="btn btn-square mx-1" href="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="500" height="500" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
