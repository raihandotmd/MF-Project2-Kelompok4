        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/about"> Rilis Movies </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/about"> Top Movies </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="about.html"> Promo </a>
              </li>
              <li class="nav-item">
          ...
          <div class="carousel-item active">
            <div class="container-fluid ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="assets/images/hulk2.png" alt="">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="carousel-item ">
            <div class="container-fluid ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="assets/images/fast-furious.png" alt="">
                  </div>
                </div>
              </div>
            </div>
